package site.bleem.redis.controller;
...
import site.bleem.redis.config.RedissonDelayQueue;
import site.bleem.redis.service.RedisService;
...
public class RedisController {
    ...
    public ResponseEntity<String> ecpire(@PathVariable("key") @Validated String key,@PathVariable("time") @Validated Integer time) throws Exception {
        ...
        redisService.set(key,currentTimeMillis, Long.valueOf(time));
