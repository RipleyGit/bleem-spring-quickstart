...
@ConfigurationProperties(
    prefix = "standard-connect.udp"
)
@ConditionalOnProperty(
    name = {"standard-connect.udp.enable"},
    havingValue = "true"
)
public class UdpProperties {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof UdpProperties)) {
            return false;
        } else {
            UdpProperties other = (UdpProperties)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UdpProperties;
    }
